...
export default function CreateContactDetail() {
        ...
        <AdminLayout>
            <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h1 className="text-3xl font-bold">Create New Contact Detail</h1>
                </div>
                ...
                <form onSubmit={submit} className="bg-white rounded-lg shadow p-6 space-y-6 max-w-2xl">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border-gray-300 rounded-md shadow-sm focus:border-[#ebd2a0] focus:ring-[#ebd2a0]"
                            placeholder="e.g., Main Phone, Office Email"
                            required
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border-gray-300 rounded-md shadow-sm focus:border-[#ebd2a0] focus:ring-[#ebd2a0]"
                            placeholder="Icon name or path (optional)"
                        />
                    ...
                    <div className="flex gap-4 pt-4 border-t">
                        ...
                        >
                            {processing ? 'Creating...' : 'Create Contact Detail'}
                        </button>
                        <Link
